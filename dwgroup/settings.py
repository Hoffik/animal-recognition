"""
Django settings for dwgroup project.
...
# Static and Media files on Amazon S3
# STATICFILES_DIRS = [
#     os.path.join(BASE_DIR, 'birds/static'),
# ]
...
# DEFAULT_FILE_STORAGE = 'dwgroup.storage_backends.MediaStorage'
